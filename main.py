...
from actions.v1_action_fct_dev_1_partie_2 import AppFctDevPartie2
from actions.v1_action_fct_dev_2_partie_2 import AppFctDev2Partie2
...
class AppWindow(QMainWindow):
    ...
    # TODO 2 : ajouter les fenetres (répertoire gui) et les actions (répertoire actions) correspondant aux 2 items de la partie 2. Test if I'm commiting right
    ...
    fct_dev_1_dialog = None
    fct_dev_2_dialog = None
    ...
    def open_fct_dev_1(self):
        if self.fct_dev_1_dialog is not None:
            self.fct_dev_1_dialog.close()
        self.fct_dev_1_dialog = AppFctDevPartie2(self.data)
        self.fct_dev_1_dialog.show()

    def open_fct_dev_2(self):
        if self.fct_dev_2_dialog is not None:
            self.fct_dev_2_dialog.close()
        self.fct_dev_2_dialog = AppFctDev2Partie2(self.data)
        self.fct_dev_2_dialog.show()
